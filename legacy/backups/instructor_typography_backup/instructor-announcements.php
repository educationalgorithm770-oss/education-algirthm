...
<body>
    ...
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
            <div>
                <h1 style="font-size: 1.85rem; font-weight: 800; letter-spacing: -0.03em;">Track Cohort Announcements</h1>
                <p style="color: var(--text-muted); font-size: 0.92rem; margin-top: 0.25rem;">Broadcast alerts and project milestone updates directly to your enrolled students.</p>
            </div>
        </div>
        ...
        <!-- BROADCAST FORM -->
        <div class="card">
            <h3 style="font-size: 1.2rem; font-weight: 800; margin-bottom: 1.25rem;">📢 Post Track Announcement</h3>
            <form method="POST">
