...
<body>
    ...
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            <div>
                <h1 style="font-size: 1.85rem; font-weight: 800; letter-spacing: -0.03em;">Live Cohort Masterclasses</h1>
                <p style="color: var(--text-muted); font-size: 0.92rem; margin-top: 0.25rem;">Host interactive Zoom / Google Meet masterclasses strictly for your enrolled students.</p>
            </div>
        </div>
        ...
        <!-- SCHEDULE FORM -->
        <div class="card">
            <h3 style="font-size: 1.2rem; font-weight: 800; margin-bottom: 1.25rem;">🔴 Schedule Upcoming Masterclass</h3>
        ...
        <!-- SCHEDULED ROSTER -->
        <div class="card">
            <h3 style="font-size: 1.2rem; font-weight: 800; margin-bottom: 1.25rem;">Scheduled Masterclasses</h3>
                        ...
                        <?php else: ?>
                            <?php foreach ($liveClasses as $lc): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= htmlspecialchars($lc['meeting_url']) ?>" target="_blank" style="background: linear-gradient(135deg, #10b981, #059669); color: #fff; text-decoration: none; padding: 0.45rem 0.9rem; border-radius: 8px; font-weight: 700; font-size: 0.8rem; display: inline-flex; align-items: center; gap: 0.35rem;">
                                            Start Room ➔
                                        </a>
                                    </td>
                                </tr>
