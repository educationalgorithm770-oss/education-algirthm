...
<body>
    ...
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
            <div>
                <h1 style="font-size: 1.45rem; font-weight: 800; letter-spacing: -0.03em;">Student Assignment Reviews & Code Grader</h1>
                <p style="color: var(--text-muted); font-size: 0.82rem; margin-top: 0.2rem;">Inspect GitHub repositories and project deliverables submitted by your enrolled students.</p>
            </div>
        ...
        <div class="card">
            <h3 style="font-size: 1.05rem; font-weight: 700; margin-bottom: 1.25rem;">Submitted Projects & Code Reviews</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($sub['file_path'])): ?>
                                            <a href="download-submission.php?id=<?= (int)$sub['id'] ?>" target="_blank" rel="noopener noreferrer" style="color: #38bdf8; text-decoration: none; font-weight: 700;">📂 Download Deliverable ↗</a>
