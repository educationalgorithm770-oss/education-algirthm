...
<body>
    ...
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
            <div>
                <h1 style="font-size: 1.45rem; font-weight: 800; letter-spacing: -0.03em;">Faculty Profile & Academic Settings</h1>
                <p style="color: var(--text-muted); font-size: 0.82rem; margin-top: 0.2rem;">Manage your official faculty contact details, phone number, bio, and account credentials.</p>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 1.5rem;" class="grid-2">
            ...
            <div class="card">
                <h3 style="font-size: 1.05rem; font-weight: 700; margin-bottom: 1.25rem;">👤 Faculty Profile & Contact Information</h3>
                <form method="POST">
